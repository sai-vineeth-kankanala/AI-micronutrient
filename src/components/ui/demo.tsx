...
// @ts-ignore - Module might not be resolved immediately or available
...
export default function DemoOne() {
  ...
  return (
    <div className="w-full h-screen bg-black relative overflow-hidden">
      {activeEffect === "mesh" && typeof MeshGradient !== 'undefined' && (
        <MeshGradient
      ...
      {activeEffect === "dots" && typeof DotOrbit !== 'undefined' && (
      ...
      {activeEffect === "combined" && typeof MeshGradient !== 'undefined' && typeof DotOrbit !== 'undefined' && (
        <>
          <MeshGradient
            className="w-full h-full absolute inset-0"
            colors={["#000000", "#1a1a1a", "#333333", "#ffffff"]}
